...
const groups: Group[] = [
  {
    ...
    members: [
      {
        name: "Ms. Albina Omirzhanova",
        title: "Cluster Head - CIS Region",
        image: team1,
        showSocial: true,
      },
      {
        name: "Mr. Senthil Nagaraj",
  ...
  },
  {
    ...
    members: [
      {
        name: "Mr. Subhani Shaik",
        title: "Manager - International Business, Africa & South Asia",
        image: team8,
        showSocial: false,
      },
      {
        name: "Mr. Sankalp Zodape",
        title: "Regional Business Development Asst. Manager - GCC & LATAM",
        image: team11,
        showSocial: false,
      },
      {
        name: "Mr. Getaneh Eneyew Demessie",
        title: "Commercial Director - Ethiopia",
        image: team9,
        showSocial: false,
      },
      {
        name: "Mr. Asaye Ashengo",
        title: "Country Manager - Ethiopia",
        image: team10,
        showSocial: false,
      },
    ],
  },
  {
    ...
    members: [
      {
        name: "Mr. Suneel Babu Bejjam",
        title: "Business Development Manager - UAE",
        image: team12,
        showSocial: false,
      },
      {
        name: "Mr. Fawzy Elsorajy",
        title: "Business Development Manager - UAE",
        image: team13,
        showSocial: false,
      },
      {
        name: "Ms. Lena Alsayed",
        title: "Business Development Executive - UAE",
        image: team14,
        showSocial: false,
      },
      {
        name: "Dr. Iftikhar Alam",
        title: "Veterinary Business Development Executive - UAE",
        image: team15,
        showSocial: false,
      },
      {
        name: "Mr. Saffy Palathingal",
        title: "Veterinary Business Development Executive - UAE",
        image: team16,
        showSocial: false,
      },
  ...
  },
  {
    ...
    members: [
      {
        name: "Ms. Ruchira A Poojary",
        title: "Sr. Manager, NPD & In - Licensing - Global",
        image: team17,
        showSocial: false,
      },
      {
        name: "Mr. Anatoly",
        title: "Sr. Manager, NPD & In - Licensing - CIS",
        image: team18,
        showSocial: false,
      },
    ],
    ...
    members: [
      {
        ...
        title: "QPPV & Regulatory Affairs Manager",
        image: team20,
        showSocial: false,
      },
      {
        name: "Mr. Chennaiah Puttapaka",
        title: "Regulatory Affairs Asst. Manager - Africa",
        image: team21,
        showSocial: false,
      },
      {
        name: "Mr. Sarun P",
        title: "Regulatory Affairs Asst. Manager - GCC",
        image: team22,
        showSocial: false,
      },
      {
  ...
  },
  {
    ...
    members: [
      {
        name: "Mr. Abhilash Nanupillai",
        title: "Finance Manager",
        image: team24,
        showSocial: false,
      },
      {
        name: "Mr. Akshay Pambadiyil",
        title: "General Accountant - UAE",
        image: team25,
        showSocial: false,
      },
      {
        name: "Mr. Ilyas Ibrahim",
  ...
  },
  {
    ...
    members: [
      {
        name: "Mr. Faim K Pathan",
        title: "Corporate Secretary & Sr. Officer",
        image: team28,
        showSocial: false,
      },
      {
        name: "Mr. Tanveer Hussain",
        title: "PRO",
        image: team29,
        showSocial: false,
      },
      {
        name: "Ms. Shokhista",
        title: "PA to CEO / HR Executive - UAE",
        image: team30,
        showSocial: false,
      },
      {
        name: "Ms. Ksennia",
        title: "Office Manager UAE",
        image: team31,
        showSocial: false,
      },
      {
        name: "Ms. Deepita",
        title: "Executive Asst. Legal & HR",
        image: team32,
        showSocial: false,
      },
    ],
...
export function Teams() {
  return (
    <>
      <SEO
        title="Our Team - THESAY PHARMA | Expert Professionals in Healthcare"
        description="Meet the dedicated leadership and team of professionals behind THESAY Pharma, driving excellence in pharmaceutical distribution and global healthcare services."
        keywords="thesay pharma team, pharmaceutical leadership, healthcare management dubai, pharma experts UAE, medical distribution team'"
      />
            ...
            <div className="container mx-auto px-4 md:px-8">
              {groups.map((group, gi) => (
                <div key={group.heading}>
                  {/* Section Title */}
                  <div
                    className={`sec-title center mb-[50px] ${gi > 0 ? "mt-[50px]" : ""}`}
                  >
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
                    {group.members.map((member, index) => (
                      ...
                      >
                        <div className="inner-box relative z-10 transition-all duration-300 rounded-[20px] bg-white hover:bg-[#0f3d2e] overflow-hidden">
                          {/* Image */}
                          <figure className="image rounded-t-[20px] overflow-hidden transition-all duration-300 relative">
                            ...
                            <div
                              className="absolute bottom-0 left-0 w-[300px] h-[300px] opacity-0 group-hover:opacity-100 transition-all duration-500"
                              style={{
                                background:
                          ...
                          {member.showSocial && (
                            <div className="socials w-[40px] h-[40px] rounded-full bg-[#27ae3f] text-white absolute right-5 bottom-[83px] cursor-pointer text-sm transition-all duration-300 flex items-center justify-center group-hover:bg-[#0f3d2e] group-hover:text-[#27ae3f]">
                              <Plus
                                size={16}
                                className="transition-all duration-300 group-hover:rotate-135"
                              />
                              <ul className="absolute bottom-[45px] right-0 flex flex-col items-center gap-1.5 invisible group-hover:visible">
                                <li className="opacity-0 invisible translate-y-2.5 transition-all duration-700 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
                                  <a
                                    href="#"
                                    className="w-[40px] h-[40px] rounded-full bg-white text-[#27ae3f] flex items-center justify-center hover:bg-[#27ae3f] hover:text-white transition-all duration-300"
                                  >
                                    <Linkedin size={16} />
                                  </a>
                                </li>
