...
export function About() {
                ...
                <div className="inner-column">
                  <div className="sec-title max-w-[570px]">
                    <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                      ...
                      <span className="text-[#051B05] font-bold">
                    ...
                    <p className="text-gray-500 leading-relaxed mt-[30px] text-justify text-lg">
                      ...
                      comprehensive range of Medical and Pharmaceutical products
                      from more than 50+ multinational companies across the
                      globe. We have built our brand and its reputation as a
                      trustworthy and results-oriented organization.
                    </p>
                  </div>
                </div>
              </motion.div>
                  ...
                  <div className="tab-content mt-[30px]">
                    <div className="content-box">
                      <p className="text text-gray-500 leading-relaxed text-justify mt-[30px] text-lg">
                        ...
                        ensures efficient market access, reliable supply chains,
                        and consistent product availability across diverse
                        healthcare markets.
                        <br />
                        <br />
                        The company holds a leading position among the top three
                        suppliers of inhalation anesthetics in the GCC and CIS
                        markets, reflecting its strength in regulated
  ...
  "
                  ...
                  <p className="text  leading-relaxed text-justify mt-[30px] text-lg">
                    ...
                    institution, steering the strategic vision, governance, and
                    capital allocation for our entire corporate group. As a
                    premier investment holding company, it drives growth across
                    diversified portfolios and fosters innovation within its key
                    operating entities.
                  </p>
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10">
            <div className="sec-title mb-[50px]">
              <div className="flex-content">
                <h2 className="title text-3xl md:text-5xl font-bold text-[#0f3d2e]">
                  Leading the Way in Global Healthcare Solutions
                </h2>
              </div>
            </div>
            ...
            >
              <div className="col-md-12">
                <p className="text-gray-600 leading-relaxed text-justify text-lg">
                  ...
                  diagnostic products from leading international manufacturers.
                  We offer a comprehensive portfolio covering human health,
                  veterinary care, medical devices, and diagnostic solutions.
                  <br />
                  <br />
                  With a robust distribution network across the GCC, CIS, LATAM
                  South Asia and African regions, we ensure timely and reliable
                  delivery of essential healthcare products, including
                  inhalation anesthetics. Our operations are guided by a
                  commitment to excellence, compliance, and innovation,
