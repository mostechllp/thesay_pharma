      ...
      <div className="min-h-screen bg-white font-sans text-gray-800">
        ...
        <main>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 flex flex-col lg:flex-row gap-12">
            {/* Main Content */}
            <div className="lg:w-2/3 px-0 md:px-[50px]">
              {/* Featured Image */}
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {gallery.map((image, idx) => (
                      <div
                        key={idx}
                        className="rounded-lg overflow-hidden bg-gray-200 aspect-[16/9] md:aspect-square cursor-pointer group relative"
